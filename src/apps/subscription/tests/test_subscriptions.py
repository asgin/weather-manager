...
class SubscriptionTest(APITestCase):
    ...
    def setUp(self):
        self.user = WeatherManagerUser.objects.create_user(id=2, email='2lO9o@example.com', password='test1234', username='test')
    ...
    def test_subscribe(self):
        self.client.post('/subscriptions/', data={'send_every_hours': 2, 'city': 'London'})
